...
class DiscordWebhookNotifier:
    def __init__(self, webhook_url: str, top_n: int):
...
def _send_rest_jobs(webhook_url: str, jobs: list, today: str | None = None):
...
def _save_records(records: list, today: str | None = None):
