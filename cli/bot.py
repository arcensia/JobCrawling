...
from core.path import HISTORY_PATH, APPLIED_PATH
...
cfg = load_config()
TARGET_CHANNEL_ID = int(cfg.discord.channel_id) if cfg.discord.channel_id else 0
